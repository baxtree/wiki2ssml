    ...
    describe("Test parser", () => {
        ...
        describe("Type for interpretation", () => {
            ...
            var sad = [
                ...
                {expression: "[[type:time,format:hms24,detail:unknown|TEXT]]", expected: HEAD + "<say-as interpret-as=\"time\" format=\"hms24\" detail=\"1\">TEXT</say-as>" + TAIL},
            ];
        ...
        it("should detect and validate markups", () => {
            ...
            expect(undertest.hasValidMarkups("[[volume:medium|TEXT]] and [[silence:5s]] and [[substitute:substitute|original]] are markups")).to.be.true;
        });
